...
public class ShakespeareConverterConsumerProducer {
	...
	public void createConsumer() throws InterruptedException {
		...
		prodProps.put("bootstrap.servers", "broker1:9092");
		...
		KafkaProducer<Object, Object> producer = new KafkaProducer<Object, Object>(prodProps);
		...
		while(true) {
			...
			for (ConsumerRecord<String, String> record : records) {
				...
				ProducerRecord<Object, Object> avroRecord = new ProducerRecord<Object, Object>(
						"shakespeare_avro_topic", shakespeareKey, shakespeareLine);
